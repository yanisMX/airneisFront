...
return (
    <div>Conditions Générales d'utilisations

    APERÇU
    Ce site web est exploité par Àirneis. Partout sur le site, nous employons les termes « nous », « notre » et « nos » en référence à Àirneis. Ce site web, y compris l'ensemble des informations, outils et services auquel il donne accès, est offert par Àirneis à l'utilisateur que vous êtes, à condition que vous acceptiez la totalité des modalités, conditions, politiques et avis stipulés ici.
    ...
    4 – MODIFICATIONS DU SERVICE ET DES PRIX
    ...
    5 – PRODUITS OU SERVICES (le cas échéant)
    ...
    9 – COMMENTAIRES, RETOURS D'EXPÉRIENCE ET AUTRES SOUMISSIONS
    ...
    Les présentes Conditions d’utilisation resteront en vigueur, à moins et jusqu’à ce qu’elles soient résiliées par vous ou par nous. Vous pouvez résilier ces Conditions d’utilisation à tout moment en nous avisant que vous ne souhaitez plus utiliser nos Services, ou lorsque vous cessez d’utiliser notre site. Si nous jugeons ou suspectons, à notre seule discrétion, que vous ne respectez pas ou que vous n'avez pas respecté une quelconque modalité ou disposition des présentes Conditions d’utilisation, nous pouvons également résilier cet accord à tout moment et sans préavis. Vous demeurerez alors responsable de toutes les sommes redevables jusqu’à la date de résiliation (incluse), en conséquence de quoi nous pouvons vous refuser l’accès à nos Services (ou à une partie de ceux-ci).
    ...
    18 – LOI APPLICABLE
    Les présentes Conditions d’utilisation, ainsi que tout accord distinct par lequel nous vous fournissons les Services sont régis et interprétés en vertu des lois de 27-33 Av. des Champs-Élysées, Paris, 75008, France.
    
    
    19 – MODIFICATIONS APPORTÉES AUX CONDITIONS D’UTILISATION
    ...
    20 – COORDONNÉES
    Les questions relatives aux Conditions d’utilisation doivent nous être envoyées à airneis@hotmail.com.
    </div>
